# This script is the primary installation script for setting up a Windows development environment.
...
function Install-LocalMachineConfig {
  ...
  Write-ErrorMsg "`n$($_.Exception.ToString())\n\nAn error occurred during the installation process.\n\nPlease ensure you are running this script from an elevated PowerShell prompt.\nIf the error persists, please check the error message above for more details.`n"
}
